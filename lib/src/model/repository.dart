...
abstract class Repository<T> {
  ...
  Future<T> get(int index) {
    ...
    assert(_totalCount == null && index == 0 || index >= 0 && index < _totalCount);
    ...
    if (!_pagesLoading.contains(page)) {
      ...
      getPage(page).then(_onPageRetrieved, onError: (error, stackTrace) => _onPageError(page, error, stackTrace));
    }
